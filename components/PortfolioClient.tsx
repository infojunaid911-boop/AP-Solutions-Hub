                ...
                <div className="relative w-full overflow-hidden">
                  ...
                  >
                    ...
                    <div className="mt-1.5 flex items-end justify-between gap-3">
                      <span className="font-display text-[14px] font-semibold leading-tight text-white md:text-[15px]">
                        {item.title}
                      </span>
    ...
    <AnimatePresence>
      {item && (
        ...
        >
          ...
          >
            {/* HERO IMAGE */}
            <div className="relative aspect-[16/10] w-full overflow-hidden bg-mist md:aspect-[16/9]">
              <Image
            ...
            {item.images.length > 1 && (
              <div className="flex gap-2 overflow-x-auto border-b border-ink/8 p-4 md:p-5">
            ...
            <div className="p-6 md:p-10">
              <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                <div className="max-w-2xl">
                  ...
                  <h3 className="mt-2 font-display text-3xl font-semibold leading-tight tracking-[-0.025em] text-ink md:text-4xl">
                    {item.title}
                  </h3>
                </div>
              ...
              {/* META */}
              <div className="mt-8 grid grid-cols-1 gap-6 border-y border-ink/8 py-7 sm:grid-cols-2">
                <div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-[15px] font-medium leading-6 text-ink">
                    {item.services.join(", ")}
                  </p>
                </div>
              </div>
              ...
              {/* DESCRIPTION */}
              <p className="mt-7 max-w-3xl text-[15px] leading-7 text-ink/60 md:text-base md:leading-8">
                {item.description}
              </p>
            </div>
          </motion.div>
